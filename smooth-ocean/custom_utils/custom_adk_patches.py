...
from google.adk.tools.mcp_tool.mcp_toolset import MCPToolset, ToolPredicate # , SseServerParams, StreamableHTTPServerParams
...
CUSTOM_STDIO_TIMEOUT_SECONDS = 3600  # 3600 seconds instead of the default 5 seconds
